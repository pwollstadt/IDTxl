...
do
    python test/performancetest_lorenz_2_long.py --n_java_threads=1 --multiprocessing=1 --n_processes=$n_processes
    wait
    date
done
...
do
    python test/performancetest_lorenz_2_long.py --n_java_threads=2 --multiprocessing=1 --n_processes=$n_processes
    wait
    date
done
...
do
    python test/performancetest_lorenz_2_long.py --n_java_threads=4 --multiprocessing=1 --n_processes=$n_processes
    wait
    date
done
