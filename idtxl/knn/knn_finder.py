...
class KnnFinder:
    ...
    def find_neighbors(self, x: np.ndarray, k: int) -> np.ndarray:
        ...
        Args:
            x (np.ndarray): The points to find neighbors for.
            k (int): The number of neighbors to find.
            
            
        Returns:
            np.ndarray: Array of lists of distances to the k nearest neighbors for each point in x.
            np.ndarray: Array of lists of indices of the k nearest neighbors for each point in x.
        """
    ...
    def find_neighbors_within(self, x: np.array, r: float) -> np.ndarray:
        ...
        Args:
            x (np.ndarray): The points to find neighbors for.
            r (float): The radius to find neighbors within.
    ...
    def find_dist_to_kth_neighbor(self, x: np.ndarray, k: int) -> np.ndarray:
        ...
        Default implementation uses find_neighbors and returns the distance to the kth neighbor.
    ...
    def count_neighbors_within(self, x: np.ndarray, r: float) -> np.ndarray:
        ...
        The default implementation uses find_neighbors and counts the number of neighbors in each list.

        Args:
            x (np.ndarray): The points to count neighbors for.
            r (float): The radius to count neighbors within.
            
        Returns:
            np.ndarray: The number of neighbors within the given radius for each point in x.
        """
