...
class ResultsNetworkInference(ResultsNetworkAnalysis):
    ...
    def export_networkx_source_graph(self, target,
        ...
        current_value = self.get_single_target(
        ...
        if sign_sources:  # Add only significant past variables as nodes.
            ...
            # Get source indices
            sources_tested = self.get_single_target(
        ...
        selected_sources_te = self.get_single_target(
            target=target, fdr=fdr)['selected_sources_te']
        selected_sources_pval = self.get_single_target(
            target=target, fdr=fdr)['selected_sources_pval']
