...
# sphinx-quickstart on Wed Dec 21 16:57:07 2016.
#
...
latex_documents = [
  ('index', 'IDTxl.tex', 'IDTxl Documentation',
   'Patricia Wollstadt, Michael Wibral, Joe T. Lizier, Finn Connor, Raul Vicente', 'manual'),
]
...
man_pages = [
    ('index', 'idtxl', 'IDTxl Documentation',
     ['Patricia Wollstadt, Michael Wibral, Joe T. Lizier, Finn Connor, Raul Vicente'], 1)
]
...
texinfo_documents = [
  ('index', 'IDTxl', 'IDTxl Documentation',
   'Patricia Wollstadt, Michael Wibral, Joe T. Lizier, Finn Connor, Raul Vicente', 'IDTxl', 'One line description of project.',
   'Miscellaneous'),
]
